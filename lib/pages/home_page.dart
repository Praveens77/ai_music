...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton("251f8097af204262f6a9d39bed9688812e956eca572e1d8b807a3e2338fdd0dc/stage",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: Drawer(
          child: Container(
              ...
              ? [
              100.heightBox,
              "Channels List".text.xl.white.semiBold.make().px16(),
              20.heightBox,
              ListView(
                padding: Vx.m0,
                shrinkWrap: true,
    ...
    "Say Hey Alan or tap the Icon".text.italic.semiBold.white.make(),
    15.heightBox,
    VxSwiper.builder(
    ...
    10.heightBox,
    "Double tap here to listen".text.gray300.make(),
    ].vStack())
    ],
    ))
        .clip(Clip.antiAlias)
